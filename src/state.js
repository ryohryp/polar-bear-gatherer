...
export function initState({ canvas, ctx, ui }) {
  ...
  document.addEventListener('keydown', event => state.keys.add(event.key));
...
export function log(message) {
  if (state.ui?.log) state.ui.log.textContent = message;
}
